...
func (m *MockAllProjectApp) CheckRoleRights(neededPerms []string, neededRole, givenPerms, givenRole string) error {
	m.ctrl.T.Helper()
...
func (mr *MockAllProjectAppMockRecorder) CheckRoleRights(neededPerms, neededRole, givenPerms, givenRole interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckRoleRights", reflect.TypeOf((*MockAllProjectApp)(nil).CheckRoleRights), neededPerms, neededRole, givenPerms, givenRole)
}
